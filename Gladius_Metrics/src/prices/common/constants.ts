...
import { UniswapPair__getReservesResult } from "../../../generated/GladiusOrderReactor/UniswapPair";
import { SushiSwapPair__getReservesResult } from "../../../generated/GladiusOrderReactor/SushiSwapPair";
...
CURVE_CALCULATIONS_ADDRESS_MAP.set(
  BASE.NETWORK_STRING,
  BASE.CURVE_CALCULATIONS_ADDRESS
);
...
CURVE_POOL_REGISTRY_ADDRESS_MAP.set(
  BASE.NETWORK_STRING,
  BASE.CURVE_POOL_REGISTRY_ADDRESS
);
...
SUSHISWAP_CALCULATIONS_ADDRESS_MAP.set(
  BASE.NETWORK_STRING,
  BASE.SUSHISWAP_CALCULATIONS_ADDRESS
);
...
YEARN_LENS_CONTRACT_ADDRESS.set(
  BASE.NETWORK_STRING,
  BASE.YEARN_LENS_CONTRACT_ADDRESS
);
...
CHAIN_LINK_CONTRACT_ADDRESS.set(
  BASE.NETWORK_STRING,
  BASE.CHAIN_LINK_CONTRACT_ADDRESS
);
...
AAVE_ORACLE_CONTRACT_ADDRESS.set(
  BASE.NETWORK_STRING,
  BASE.AAVE_ORACLE_CONTRACT_ADDRESS
);
...
ONE_INCH_ORACLE_CONTRACT_ADDRESS.set(
  BASE.NETWORK_STRING,
  BASE.ONE_INCH_ORACLE_CONTRACT_ADDRESS
);
...
USDC_DECIMALS_MAP.set(BASE.NETWORK_STRING, BASE.USDC_DECIMALS);
...
WHITELIST_TOKENS_MAP.set(BASE.NETWORK_STRING, BASE.WHITELIST_TOKENS);
